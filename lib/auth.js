...
function readStableSecretMaterial() {
  ...
  const serviceAccountSecret = getEnv("GOOGLE_PRIVATE_KEY") || getEnv("GOOGLE_CLIENT_EMAIL");
...
async function exportUserData(userId) {
  ...
  return {
    ...
    note: "Pour obtenir l'ensemble des données associées (rencontres, formations), contactez l'administrateur."
  };
}
